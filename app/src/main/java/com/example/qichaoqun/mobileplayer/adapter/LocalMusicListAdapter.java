...
public class LocalMusicListAdapter extends BaseAdapter {
    ...
    public LocalMusicListAdapter(Context context, ArrayList<VideoBean> videoList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView imageView = convertView.findViewById(R.id.local_music_image);
        TextView videoName = convertView.findViewById(R.id.local_music_name);
        TextView videoTime = convertView.findViewById(R.id.local_music_time);
        TextView videoSize = convertView.findViewById(R.id.local_music_size);
